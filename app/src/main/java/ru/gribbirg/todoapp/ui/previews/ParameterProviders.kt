...
class TextPreviewParameterProvider : PreviewParameterProvider<String> {
    override val values: Sequence<String>
        get() = sequenceOf(
            "Test text 1",
            "Интересный текст о том, как интересно читать этот текст, ведь этот текст такой интересный!",
...
class TodoItemPreviewParameterProvider : PreviewParameterProvider<TodoItem> {
